...
namespace WatchFace.Parser.Models.Elements
{
    public class WeatherIconsElement : CompositeElement, IDrawable
    {
        ...
        public ImageElement CustomImage { get; set; }
        ...
        public void Draw(Graphics drawer, Bitmap[] resources, WatchState state)
        {
            ...
            if (iconCoordinates != null && CustomIcon == null)
                drawer.DrawImage(LoadWeatherImage(state.CurrentWeather, resources), 
                    iconCoordinates.X, iconCoordinates.Y);
            
            if (CustomIcon != null)
                drawer.DrawImage(resources[CustomIcon.ImageIndex + (int)state.CurrentWeather], CustomIcon.X, CustomIcon.Y);
        }

        private static Bitmap LoadWeatherImage(WeatherCondition weather, Bitmap[] resources)
        {
            ...
            //return resources[iconCoordinates (int)weather];
        }
        ...
        protected override Element CreateChildForParameter(Parameter parameter)
        {
            switch (parameter.Id)
            {
                ...
                //    return CustomIcon;
                ////case 2:
                ////    CustomImage = new ImageElement(parameter, this);
                ////    return CustomImage;
                //case 3:
