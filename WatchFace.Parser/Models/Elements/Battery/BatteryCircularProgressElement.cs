...
{
    public class BatteryCircularProgressElement : CircularProgressElement
    {
        public BatteryCircularProgressElement(Parameter parameter, Element parent = null, string name = null) :
